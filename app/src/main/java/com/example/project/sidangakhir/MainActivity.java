...
public class MainActivity extends AppCompatActivity
    ...
    private String userId, userName, judul;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtUserId = (TextView)header.findViewById(R.id.txtNavHeaderNIK);
        txtNamaUser = (TextView)header.findViewById(R.id.txtNavHeaderNama);
        imgInfo = (ImageView)header.findViewById(R.id.imgNavHeaderInfo);

        txtUserId.setText("ID: "+userId);
